    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('apartment_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='db.apartments')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='db.user')),
            ],
        ),
        migrations.CreateModel(
            name='bill',
